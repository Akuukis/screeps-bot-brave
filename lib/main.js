module.exports.loop = function() {
    ...
    for(var id in Memory.squads.upgr){
    };
    for(var id in Memory.squads.mine){
    ...
    for(var id in Memory.squads.deff){
    	var squad = Memory.squads.deff[i];
    };
    for(var id in Memory.squads.patr){
    	var squad = Memory.squads.patr[i];
    };
    for(var id in Memory.squads.offn){
    	var squad = Memory.squads.offn[i];
    };
    for(var id in Memory.squads.esco){
    	var squad = Memory.squads.esco[i];
    };
    for(var id in Memory.squads.scot){
    ...
    for(var id in Game.rooms){ // Make overlay for each unexplored room.
    ...
    for(var id in []/*Memory.demand*/){ // Distribute spawning demands to spawns.
    ...
    for(var name in Game.creeps){ // Take care of transits.
